      ...
      _i1.FieldNode(
          ...
          arguments: [
            ...
            _i1.ArgumentNode(
                name: _i1.NameNode(value: 'nextToken'),
                value:
                    _i1.VariableNode(name: _i1.NameNode(value: 'nextToken'))),
            _i1.ArgumentNode(
...
const GetHabit = _i1.OperationDefinitionNode(
    ...
    selectionSet: _i1.SelectionSetNode(selections: [
      _i1.FieldNode(
          ...
          selectionSet: _i1.SelectionSetNode(selections: [
            _i1.FragmentSpreadNode(
                name: _i1.NameNode(value: 'AllHabitFields'), directives: [])
          ]))
    ]));
...
const GetComment = _i1.OperationDefinitionNode(
    ...
    selectionSet: _i1.SelectionSetNode(selections: [
      _i1.FieldNode(
          ...
          selectionSet: _i1.SelectionSetNode(selections: [
            _i1.FragmentSpreadNode(
                name: _i1.NameNode(value: 'AllCommentFields'), directives: [])
          ]))
    ]));
...
const CreateUser = _i1.OperationDefinitionNode(
    ...
    variableDefinitions: [
      ...
      _i1.VariableDefinitionNode(
          variable:
              _i1.VariableNode(name: _i1.NameNode(value: 'displayUsername')),
          type: _i1.NamedTypeNode(
              name: _i1.NameNode(value: 'String'), isNonNull: false),
          defaultValue: _i1.DefaultValueNode(value: null),
          directives: [])
...
const UpdateUser = _i1.OperationDefinitionNode(
    ...
    variableDefinitions: [
      _i1.VariableDefinitionNode(
          ...
          type: _i1.NamedTypeNode(
              name: _i1.NameNode(value: 'UpdateUserInput'), isNonNull: true),
          defaultValue: _i1.DefaultValueNode(value: null),
          directives: [])
    ],
    directives: [],
...
const UpdateHabit = _i1.OperationDefinitionNode(
    ...
    variableDefinitions: [
      _i1.VariableDefinitionNode(
          variable: _i1.VariableNode(name: _i1.NameNode(value: 'input')),
          type: _i1.NamedTypeNode(
              name: _i1.NameNode(value: 'UpdateHabitInput'), isNonNull: true),
          defaultValue: _i1.DefaultValueNode(value: null),
          directives: [])
    ],
    directives: [],
...
const SearchUsers = _i1.OperationDefinitionNode(
    ...
    variableDefinitions: [
      ...
      _i1.VariableDefinitionNode(
          variable:
              _i1.VariableNode(name: _i1.NameNode(value: 'excludeUsername')),
          type: _i1.NamedTypeNode(
              name: _i1.NameNode(value: 'String'), isNonNull: true),
          defaultValue: _i1.DefaultValueNode(value: null),
          directives: []),
